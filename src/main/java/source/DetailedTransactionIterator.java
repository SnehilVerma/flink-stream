...
final class DetailedTransactionIterator implements Iterator<DetailedTransaction>, Serializable {
    ...
    public DetailedTransaction next() {
        DetailedTransaction DetailedTransaction = data.get(this.index++);
